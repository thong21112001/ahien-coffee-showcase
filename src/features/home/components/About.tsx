...
export function About({ storyData, valuesData }: AboutProps) {
  if (!storyData && !valuesData) return null;
  ...
  const getIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case "clock":
        return (
          <svg width="26" height="26" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M15.9998 29.3334C8.63984 29.3334 2.6665 23.3734 2.6665 16.0001C2.6665 8.64008 8.63984 2.66675 15.9998 2.66675C23.3732 2.66675 29.3332 8.64008 29.3332 16.0001C29.3332 23.3734 23.3732 29.3334 15.9998 29.3334ZM20.2532 20.9467C20.4132 21.0401 20.5865 21.0934 20.7732 21.0934C21.1065 21.0934 21.4398 20.9201 21.6265 20.6001C21.9065 20.1334 21.7598 19.5201 21.2798 19.2267L16.5332 16.4001V10.2401C16.5332 9.68008 16.0798 9.24008 15.5332 9.24008C14.9865 9.24008 14.5332 9.68008 14.5332 10.2401V16.9734C14.5332 17.3201 14.7198 17.6401 15.0265 17.8267L20.2532 20.9467Z" fill="#955127" />
          </svg>
        );
      case "hand-point-up":
        return (
      ...
      case "leaf":
        return (
          <svg width="26" height="26" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M28.4453 5.89006C28.4144 5.78201 28.3475 5.68781 28.2556 5.6232C28.1637 5.55859 28.0524 5.52747 27.9403 5.53506C15.877 5.88819 7.5719 13.7642 6.38034 24.1952C6.37621 24.288 6.39765 24.3802 6.44232 24.4616C6.48698 24.5431 6.55316 24.6107 6.63363 24.6571C6.7141 24.7035 6.80577 24.7269 6.89864 24.7248C6.99151 24.7227 7.08202 24.6951 7.16027 24.645L18.3603 17.1201C15.8891 20.9109 12.6174 24.1144 8.77526 26.5051C7.0656 27.5495 5.24208 28.395 3.34026 29.0251C3.21626 29.0684 3.11427 29.1587 3.05629 29.2766C2.9983 29.3945 2.98898 29.5304 3.03032 29.6551C3.07167 29.7797 3.16037 29.8832 3.27728 29.943C3.3942 30.0029 3.52997 30.0144 3.65529 29.9751C5.54323 29.3471 7.35723 28.5155 9.06526 27.4951C13.7803 29.9901 18.8803 27.9651 19.1003 27.8751C33.0803 22.0951 28.4953 6.05006 28.4453 5.89006Z" fill="#955127" />
            <path d="M6.09527 20.5251C7.31913 16.165 9.87492 12.2964 13.4053 9.46009C12.8538 6.34559 10.6982 2.91109 7.77524 2.02509C7.69345 1.99856 7.60616 1.99383 7.52199 2.01136C7.43781 2.0289 7.35967 2.0681 7.29529 2.12509C3.84317 5.12696 -0.223769 13.4995 6.09527 20.5251Z" fill="#955127" />
          </svg>
        );
      default:
        return null;
  ...
  const storySubtitle = storyData?.subtitle || "";

  const contentParts = storyData?.content ? storyData.content.split(/\n\n+/) : [];
  let meaningTitle = "";
  let meaningParagraphs: string[] = [];
  ...
  const img1 = (storyImages[0]?.image ? getImageUrl(storyImages[0].image) : "") || IMAGES.about.image1;
  const img2 = (storyImages[1]?.image ? getImageUrl(storyImages[1].image) : "") || IMAGES.about.image2;
  const img3 = (storyImages[2]?.image ? getImageUrl(storyImages[2].image) : "") || IMAGES.about.image3;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 items-center mb-20">
          ...
          <div className="grid grid-cols-2 gap-4 mb-2">
            ...
            <div className="col-span-2 relative h-80 rounded-2xl overflow-hidden shadow-lg border border-stone-200/50 hover:scale-[1.01] transition-transform duration-300">
              <Image src={img1} alt={`${storyTitle} 1`} fill className="object-cover" />
            </div>
            ...
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-md border border-stone-200/50 hover:scale-[1.02] transition-transform duration-300">
              <Image src={img2} alt={`${storyTitle} 2`} fill className="object-cover" />
            </div>
            <div className="relative h-64 rounded-2xl overflow-hidden shadow-md border border-stone-200/50 hover:scale-[1.02] transition-transform duration-300">
              <Image src={img3} alt={`${storyTitle} 3`} fill className="object-cover" />
            </div>
          </div>
        </div>
